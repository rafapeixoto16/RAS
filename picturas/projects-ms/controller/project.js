...
import { buildPagination, buildSort } from '../models/queryProject.js';
...
export const getProjects = (query) => {
  ...
  return Project.find(queryObject).sort(sortObject).skip(pagination.skip).limit(pagination.limit).exec();
};
